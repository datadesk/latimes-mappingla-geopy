...
<p>from django.contrib.gis.db import models<br />
from django.contrib.gis.geos import Point</p>
<p>class ViewportExample(models.Model):<br />
  name = models.CharField(max_length=200, null=True, blank=True)<br/>
