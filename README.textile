h1. This library is no longer supported and probably should not be used. If you would like to access Google's version 3 geocoder with Python, try "python-googlegeocoder":https://github.com/datadesk/python-googlegeocoder.
