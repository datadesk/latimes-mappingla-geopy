<pre><code> '/¯¯¯¯|  |¯¯¯¯\‚        '|\¯¯¯\  °    |¯¯¯¯|\¯¯¯¯\‘    |¯¯¯¯|\¯¯¯¯\‘   |\¯¯¯\‚   '/¯¯¯¯|   /¯¯¯¯|   '/¯¯¯/|¯¯¯|'‚               |\¯¯¯\‘                '|\¯¯¯\  °  
 ...
 |'\     '|\   /|     /'|'‚ |     '|_|    °|'‚    |       |/____/|    |       |/____/|  °'\|     |'   |'\     |\  \|      '|''|° |    °| |    °|'‚              '°\|     |___¸'/|   |     '|_|    °|'‚  
 | '|   °'| '\/ '|    '|°|'‚ |     '|¯|    °|'‚    |       |      °| |    |       |      °| |   '°|     |'   | '|   °|  \       °|/   |    °|'\¯¯¯\'‚               '°|             '|   |     '|¯|    °|'‚  
 ''/___'\  | /___'\/'  |\___\_\___\‚   |____|____'|/'    |____|____'|/'    '|\__¸'\'  ''/___|\ /____¸|°   |\___\|___|                 /________|   |\___\_\___\‚ 
 '|       |'\|/|       |   | |     |  |      |   |       |       ‘      |       |       ‘      '| |     |  '|      | '\|        |    | |     ||     |               '°|              '|   | |     |  |      | 
 '|____|  °|____|  °'\|___|'°|__¸¸'|   |____|‘             |____|‘             °\|__¸'|  '|__¸¸'|  '|____''|   '°\|__¸'||__¸'|               '°|________'|  °'\|___|'°|__¸¸'| </code></pre>
...
If you're really enthuasiastic, check out "this dummy GeoDjango model":http://gist.github.com/456696 that calculate the viewport for you.
